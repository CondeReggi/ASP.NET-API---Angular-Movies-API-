...
{
    public partial class RelacionesNN : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FechLanzamiento = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GenerosPelicula", x => new { x.PeliculaId, x.GeneroId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GenerosPelicula_GeneroId",
